...
#     #   - Prevent the agent from speaking while the user is speaking (no overlap)
#     #   - Stop the agent immediately if the user interrupts (barge-in)
#     vad = silero.VAD.load()
...
#     # The timer resets every time the user speaks.
#     last_speech_time = asyncio.get_event_loop().time()
#     silence_reminder_sent = False  # prevents spamming reminders back-to-back
